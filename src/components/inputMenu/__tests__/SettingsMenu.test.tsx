...
describe("SettingsMenu", () => {
  ...
  describe("Feature Tests - Import Functionality", () => {
    ...
    it("should call import service when import button is clicked", async () => {
      ...
      ;(promptImportService.importFromCSV as any).mockResolvedValue(
        mockImportResult,
      )
      ...
      await waitFor(() => {
        expect(promptImportService.importFromCSV).toHaveBeenCalledTimes(1)
      })
    })
    ...
    it("should handle import with errors", async () => {
      ...
      await waitFor(() => {
        expect(consoleWarnSpy).toHaveBeenCalledWith("Import errors:", [
          "Error 1",
          "Error 2",
        ])
      })
    ...
    it("should handle import errors gracefully", async () => {
      const consoleErrorSpy = vi
        .spyOn(console, "error")
        .mockImplementation(() => {})
      ;(promptImportService.importFromCSV as any).mockRejectedValue(
